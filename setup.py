...
setup(
    name="accumulator-batching",
    description="Accumulator-based batching with tf.data",
    url="https://github.com/jackd/accumulator-batching",
    author="Dominic Jack",
    author_email="thedomjack@gmail.com",
    license="Apache 2.0",
    packages=["accumulator_batching"],
